/* SECURITY: DOMPurify fallback
   If DOMPurify is not available (e.g., CDN not loaded yet), use a no-op sanitizer
...
class LiveStreamManager {
    ...
    async setupStreamEmbed(platform, streamData) {
        ...
        container.innerHTML = sanitize(embedHTML);
    ...
    async initializeChat(platform, streamData) {
        ...
        chatContainer.innerHTML = sanitize(chatHTML);
    ...
    addChatMessage(messageData) {
        ...
        messageElement.innerHTML = sanitize(`
    ...
    addTrackRequest(request) {
        ...
        requestElement.innerHTML = sanitize(`
    ...
    displaySchedule(schedule) {
        ...
        scheduleContainer.innerHTML = sanitize(scheduleHTML);
